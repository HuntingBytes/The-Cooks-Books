...
/**
 * Essa classe representa a exceção no qual existe uma tentativa de realizar o login sendo que já
...
public class UsuarioJaLogado extends Exception {
  ...
  public UsuarioJaLogado(String loginUsuarioAtual) {
    super(String.format("Já existe um usuário logado! (Login usuário atual: %s)",
        loginUsuarioAtual));
