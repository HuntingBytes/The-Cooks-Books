...
/**
 * Essa classe representa a exceção no qual existe uma tentativa de cadastrar uma Receita que possui
 * o nome igual a outra Receita já cadastrada no sistema pelo usuário em questão.
 *
 * @version 1.0
 */
