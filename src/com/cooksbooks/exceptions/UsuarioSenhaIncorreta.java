...
/**
 * Essa classe representa a exceção no qual existe uma tentativa de realizar o login de um usuário
...
public class UsuarioSenhaIncorreta extends Exception {
  ...
  public UsuarioSenhaIncorreta(String loginUsuario) {
    super(String.format(
        "Senha incorreta. A senha dada para o usuário \"%s\" não coincide com a cadastrada.",
        loginUsuario));
