...
/**
 * A Classe PermissaoEspecial é responsável
 * por definir ações que um Administrador
 * pode realizar no sistema.
 *
 * Ela é responsável por diferenciar um
 * Administrador de um Usuario padrão.
 *
 * @version 1.0
 */
public enum PermissaoEspecial {
    ...
    /**
     * Retorna uma String com a representação textual
     * da permissão.
     *
    ...
    /**
     * Retorna uma lista com as permissões especiais padrão
     * para qualquer {@code Administrador}.
     *
